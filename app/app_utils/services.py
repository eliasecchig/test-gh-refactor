...
Registered under ``shared://`` so adk_api, A2A, and reasoning_engine share instances.
"""
...
def get_session_service():
    """Process-wide session service, mirroring ``AdkApp.set_up``'s choice."""
    ...
    if agent_engine_id := os.environ.get("GOOGLE_CLOUD_AGENT_ENGINE_ID"):
        ...
        return VertexAiSessionService(
            ...
            # The runtime-injected agent-engine region, not GOOGLE_CLOUD_LOCATION
            # (which agent.py pins to "global"). Matches AdkApp.set_up.
